...
public class Cell : MonoBehaviour
{
    ...
    public Tile GetTileFromPointInCell(int x, int y)
    {
        ...
        if (index >= Tiles.Length || index < 0 ) throw new UnityException("ERROR: Tile out of range --> produced by Toni");
    ...
    public Vector2 GetPointInCellFromTileIndex(int tileIndex)
    {
        ...
        if (index >= Tiles.Length) throw new UnityException("ERROR: Tile out of range  --> produced by Toni");
