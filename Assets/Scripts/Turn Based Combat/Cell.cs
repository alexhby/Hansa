...
public class Cell : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Physics.Raycast(ray, out hit))
        {
            ...
            //Debug.Log("1: [" + (int)point.x + "," + (int)point.y + "]"); //DEBUG
    ...
    public Tile ConvertStringToTile(string str)
    {
        ...
        if (split.Length != 2) throw new UnityException("Plane has been renamed  --> produced by Toni");
    ...
    public Tile GetTileFromPointInCell(int x, int y)
    {
        ...
        if (index >= Tiles.Length || index < 0 ) throw new UnityException("Tile out of range --> produced by Toni");
    ...
    public Vector2 GetPointInCellFromTileIndex(int tileIndex)
    {
        ...
        if (index >= Tiles.Length) throw new UnityException("Tile out of range  --> produced by Toni");
