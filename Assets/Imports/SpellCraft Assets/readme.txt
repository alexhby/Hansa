...
---------------------------------------------------------------------------
* SPELLCRAFT LITE v1.0.0												  *
---------------------------------------------------------------------------

SpellCraft Lite is a taster spell effects package made for Unity.

You can buy the full version of SpellCraft on the Asset Store.

Everything in the package was created at GameMechanix.
...
Under "SpellCraft Assets" find the folder named "Demo". Here you will find a "SpellCraft Effects Demo" scene file that you can load up to play the Demo.
...
You can drag and drop the prefabs from any of the 2 above folders to see how they work.
